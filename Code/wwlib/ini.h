...
//		int Line_Count(char const * section) const;
		...
		*/
		...
		const WideStringClass& Get_Wide_String(WideStringClass& new_string, char const * section, char const * entry, uint16_t const * defvalue=nullptr) const;
		...
		*/
		...
		bool Put_Wide_String(char const * section, char const * entry, const uint16_t * string);
