...
protected:
	...
	afx_msg void OnAdd();
	virtual void OnOK();
	afx_msg void OnDblclkConversationList(NMHDR* pNMHDR, intptr_t* pResult);
	afx_msg void OnDeleteitemConversationList(NMHDR* pNMHDR, intptr_t* pResult);
	afx_msg void OnKeydownConversationList(NMHDR* pNMHDR, intptr_t* pResult);
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
