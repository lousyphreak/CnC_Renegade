...
protected:
	...
	afx_msg void OnDblclkSectorList(NMHDR* pNMHDR, intptr_t* pResult);
	afx_msg void OnDeleteitemSectorList(NMHDR* pNMHDR, intptr_t* pResult);
	afx_msg void OnColumnclickSectorList(NMHDR* pNMHDR, intptr_t* pResult);
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
