...
** TextDisplayLine
*/
TextDisplayLine::TextDisplayLine( const WideStringClass & text, uint32_t color ) :
	Time( 0 ),
	LineCount( 0 ),
	Text( text ),
	Color( color )
...
void	TextDisplayGameModeClass::Print( const char * string, const Vector4 & color )
{
	...
	uint32_t col=(unsigned(color[0]*255.0f)<<24)|(unsigned(color[1]*255.0f)<<16)|(unsigned(color[2]*255.0f)<<8)|(unsigned(color[3]*255.0f));
...
void	TextDisplayGameModeClass::Print( const char * string, const Vector3 & color )
{
	...
	//TSS uint32_t col=(unsigned(color[0]*255.0f)<<24)|(unsigned(color[1]*255.0f)<<16)|(unsigned(color[2]*255.0f)<<8)|0xff;
	uint32_t col=(unsigned(color[0]*255.0f)<<16)|(unsigned(color[1]*255.0f)<<8)|(unsigned(color[2]*255.0f))|0xFF000000;
	WideStringClass wide_string;
	wide_string.Convert_From( string );
	TextDisplayLine * line = new TextDisplayLine( wide_string, col );
   ScrollLines.Add_Tail( line );
...
static uint32_t											_StatsColor = 0xFFFFFFFF;
...
void	StatisticsDisplayManager::Set_Stat( const char * title, const char * text, uint32_t color, const Vector2& location )
{
