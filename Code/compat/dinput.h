...
/*
** Non-Windows compatibility shim that provides the legacy DirectInput key
** codes used throughout Combat and Commando when the real DirectInput backend
** is disabled.
*/
