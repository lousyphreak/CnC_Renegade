...
//////////////////////////////////////////////////////////////////////
void
Sound2DHandleClass::Set_Sample_User_Data (S32 i, uintptr_t val)
{
	if (SampleHandle != (HSAMPLE)INVALID_MILES_HANDLE) {
...
//////////////////////////////////////////////////////////////////////
bool
Sound2DHandleClass::Is_Sample_Playing (void)
{
	return (SampleHandle != (HSAMPLE)INVALID_MILES_HANDLE) ? (::AIL_sample_is_playing (SampleHandle) != 0) : false;
}
...
//////////////////////////////////////////////////////////////////////
bool
Sound2DHandleClass::Is_Sample_Paused (void)
{
	return (SampleHandle != (HSAMPLE)INVALID_MILES_HANDLE) ? (::AIL_sample_is_paused (SampleHandle) != 0) : false;
}
...
//////////////////////////////////////////////////////////////////////
S32
Sound2DHandleClass::Get_Sample_Loops_Left (void)
{
	return (SampleHandle != (HSAMPLE)INVALID_MILES_HANDLE) ? ::AIL_sample_loops_left (SampleHandle) : 0;
}
...
//////////////////////////////////////////////////////////////////////
void
Sound2DHandleClass::Set_Miles_Handle (uintptr_t handle)
{
