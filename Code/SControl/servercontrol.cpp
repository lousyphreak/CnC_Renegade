 ...
 *   11/16/2001 4:01PM ST : Created                                                            *
 *=============================================================================================*/
bool ServerControlClass::Start_Listening(uint16_t port, char *password, const char*(*app_request_callback)(char*), void(*app_response_callback)(char*), bool loopback, uint32_t ip)
{
	LocalPort = port;
	if (LocalPort != 0) {
 ...
 *   11/16/2001 4:03PM ST : Created                                                            *
 *=============================================================================================*/
void ServerControlClass::Parse_Message(void *buffer, int len, uint32_t address, uint16_t port)
{
 ...
 *=============================================================================================*/
void ServerControlClass::Add_Remote_Control(uint32_t ip, uint16_t port)
{
 ...
 *=============================================================================================*/
void ServerControlClass::Remove_Remote_Control(uint32_t ip, uint16_t port)
{
	RemoteControlStruct *control;
	for (int i=0 ; i<RemoteControllers.Count() ; i++) {
		control = RemoteControllers[i];
 ...
 *   11/16/2001 4:07PM ST : Created                                                            *
 *=============================================================================================*/
bool ServerControlClass::Is_Authenticated(uint32_t ip, uint16_t port)
{
	RemoteControlStruct *control = Get_Controller(ip, port);
 ...
 *=============================================================================================*/
ServerControlClass::RemoteControlStruct *ServerControlClass::Get_Controller(uint32_t ip, uint16_t port)
{
	RemoteControlStruct *control;
	for (int i=0 ; i<RemoteControllers.Count() ; i++) {
		control = RemoteControllers[i];
 ...
 *=============================================================================================*/
void ServerControlClass::Reset_Timeout(uint32_t ip, uint16_t port)
{
	RemoteControlStruct *control = Get_Controller(ip, port);
	if (control && control->Secure && TIMEGETTIME() - control->Time < CONTROL_TIMEOUT) {
		control->Time = TIMEGETTIME();
 ...
 *   11/16/2001 4:09PM ST : Created                                                            *
 *=============================================================================================*/
void ServerControlClass::Send_Message(char *text, uint32_t ip, uint16_t port)
{
 ...
 *=============================================================================================*/
void ServerControlClass::Respond(const char *text, uint32_t ip, uint16_t port)
{
