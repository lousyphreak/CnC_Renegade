...
#include <StdMat.h>
//Moumine 3/18/2002    3:22:21 PM
#if defined W3D_BIPED
#include "bipexp.h"
#endif
...
public:
	...
	*/
	...
	void		cs_remove_nu_scale(INode * node);
...
void W3DUtilityClass::BeginEditParams(Interface *ip,IUtil *iu) 
{
	...
	ToolsPanelHWND = InterfacePtr->AddRollupPage(
		...
		0);
#if defined W3D_BIPED
//Moumine 3/18/2002    2:25:02 PM

	ToolsPanelHWND = InterfacePtr->AddRollupPage(
		AppInstance,
		MAKEINTRESOURCE(IDD_W3DUTILITY_CSTOOLS),
		_w3d_utility_cstools_dlg_proc,
		Get_String(IDS_W3DUTILITY_CSTOOLS),
		0);
#endif
//End Moumine
...
//Moumine 3/18/2002    2:34:14 PM
//============================================================================================
void W3DUtilityClass::CSRemoveNonUniformScale(void)
{
	InterfacePtr->SelectNode(NULL);
	INode * root = InterfacePtr->GetRootNode();
	descend_tree(root,CS_REMOVE_NUSCALE);
	InterfacePtr->ForceCompleteRedraw();
}
//End Moumine
//============================================================================================
...
//Moumine 3/18/2002    3:04:05 PM
	case CS_REMOVE_NUSCALE:
		cs_remove_nu_scale(node);
		break;
//End Moumine
	default:
		break;
...
//Moumine 3/18/2002    3:06:27 PM
//============================================================================================
void W3DUtilityClass::cs_remove_nu_scale(INode * node){
